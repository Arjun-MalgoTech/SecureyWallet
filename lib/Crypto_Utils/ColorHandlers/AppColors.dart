...
class AppColors {
  ...
  final Color appBodyColorLight1 = const Color(0xFFDEDFE0);
  final Color appBodyColorLight2 = const Color(0xFF66c6ed);
  final Color createWalletTextLight1 = const Color(0xFF535454);
  final Color roundedButtonColorLight1 = const Color(0xFF26CD79);
  final Color roundedButtonColorLight2 = const Color(0xFF1DB96B);
  final Color cardShadowLight = const Color(0xFFc7d0da);
  final Color textLight = Colors.black;
  final Color buttonLightDiableGrey2 = const Color(0XFFC3C3C3);
  ...
  final Color cardBackgroundLight = const Color(0XFF24242621);
  ...
  final Color roundedButtonColorDark2 = const Color(0xFF1DB96B);
  final Color buttonDiableGrey2 = Colors.white;
  ...
  final Color cardBackgroundDark = Color(0xFF242426);
