                  ...
                  Padding(
                    ...
                    child: SizedBox(
                        height: SizeConfig.height(
                            context,
                            localStorageService.assetList.length *
                                9), // Adjust height as needed
                            ...
                            : StreamBuilder(
                                ...
                                builder: (context, snapshot) {
                                  if (snapshot.hasData) {
                                    ...
                                    for (var value
                                        in localStorageService.assetList) {
                                      if (symbol.toLowerCase().contains(
                                          value.coinSymbol!.toLowerCase())) {
                                        if (result
                                            .containsKey(value.coinSymbol!)) {
                                      ...
                                      ? filteredCoins.isEmpty
                                          ...
                                          : ListView.builder(
                                              itemCount: filteredCoins
                                                  .length, // Set the number of items to the filtered list length
                                              physics:
                                                            ...
                                                            child: ListTile(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child: Image
                                                                          ...
                                                                          errorBuilder: (_,
                                                                              ...
                                                                              trc) {
                                                                            return AppText(
                                                                              filteredCoins[index].coinSymbol.toString().characters.first,
                                                                              color: Colors.white,
                                                                              fontWeight: FontWeight.bold,
                                                                            );
                                                                          },
                                                                    ...
                                                                    filteredCoins[index].coinType ==
                                                                        ...
                                                                        ? Padding(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              borderRadius: BorderRadius.circular(30),
                                                                              child: Image.network(
                                                                                localStorageService.allAssetList.indexWhere((v) => v.gasPriceSymbol == filteredCoins[index].gasPriceSymbol) == -1 ? "" : localStorageService.allAssetList[localStorageService.allAssetList.indexWhere((v) => v.gasPriceSymbol == filteredCoins[index].gasPriceSymbol)].imageUrl!,
                                                              ...
                                                              title: Column(
                                                                ...
                                                                children: [
                                                                    ...
                                                                    children: [
                                                                      AppText(
                                                                        ...
                                                                        color: Theme.of(context)
                                                                            ...
                                                                            .surfaceBright,
                                                                        overflow:
                                                                            TextOverflow.ellipsis, // This ensures truncation if needed
                                                                      ),
                                                                      SizedBox(
                                                                          width:
                                                                              10),
                                                                      ...
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                            AppText(
                                                                              filteredCoins[index].network!,
                                                                              fontSize: 10,
                                                                              overflow: TextOverflow.ellipsis, // Ensure truncation here too
                                                                            ),
                                                                          ),
                                                                        ),
                                                                      ),
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      result.containsKey(
                                                                              filteredCoins[index].coinSymbol!)
                                                                          ? AppText(
                                                                          ...
                                                                          : AppText(
                                                                              filteredCoins[index].coinType == '2' ? "Token" : "Crypto",
                                                                              fontSize: 13,
                                                                              fontWeight: FontWeight.w400,
                                                                              color: Theme.of(context).colorScheme.surfaceBright,
                                                                            ),
                                                                      ...
                                                                      result.containsKey(
                                                                          ...
                                                                          ? Row(
                                                                              children: [
                                                                                AppText(
                                                                                  double.parse(result[filteredCoins[index].coinSymbol!]![1].toString()) < 0 ? '' : '+',
                                                                                  fontSize: 12,
                                                                                  color: double.parse(result[filteredCoins[index].coinSymbol!]![1].toString()) < 0 ? Color(0xFFFD0000) : Colors.green,
                                                                                ),
                                                                                AppText(
                                                              ...
                                                              trailing: Column(
                                                                ...
                                                                children: [
                                                                  AppText(
                                                                    isTextVisible
                                                                        ? (double.tryParse(allBalance1[index]) != null &&
                                                                                double.tryParse(allBalance1[index])! > 0
                                                                            ? double.tryParse(allBalance1[index])!.toStringAsFixed(6).replaceAll(RegExp(r"([.]*0+)(?!.*\d)"), "") // Remove trailing zeros
                                                                            : "0")
                                                                        : "****",
                                                                    fontSize:
                                                                        15,
                                                        ...
                                                        child: ListTile(
                                                                ...
                                                                localStorageService
                                                                    ...
                                                                    ? Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Image.network(
                                                                            localStorageService.allAssetList.indexWhere((v) => v.gasPriceSymbol == localStorageService.assetList[index].gasPriceSymbol) == -1
                                                                                ? ""
                                                                                : localStorageService.allAssetList[localStorageService.allAssetList.indexWhere((v) => v.gasPriceSymbol == localStorageService.assetList[index].gasPriceSymbol)].imageUrl!,
                                                                            errorBuilder: (_,
                                                                                obj,
                                                                                trc) {
                                                                              return AppText(
                                                                                localStorageService.assetList[index].gasPriceSymbol.toString(),
                                                                                color: Colors.white,
                                                                                fontWeight: FontWeight.bold,
                                                                                fontSize: 7,
                                                                              );
                                                          ...
                                                          title: Column(
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                children: [
                                                                  result.containsKey(localStorageService
                                                                          .assetList[
                                                                              index]
                                                                          .coinSymbol!)
                                                                      ? AppText(
                                                                      ...
                                                                      : AppText(
                                                                          localStorageService.assetList[index].coinType == '2'
                                                                              ? "Token"
                                                                              : "Crypto",
                                                                          fontSize:
                                                                              13,
                                                                  ...
                                                                  result.containsKey(localStorageService
                                                                      ...
                                                                      ? Row(
                                                                          children: [
                                                                            AppText(
                                                                              double.parse(result[localStorageService.assetList[index].coinSymbol!]![1].toString()) < 0 ? '' : '+',
                                                                              fontSize: 12,
                                                                              color: double.parse(result[localStorageService.assetList[index].coinSymbol!]![1].toString()) < 0 ? Color(0xFFFD0000) : Colors.green,
                                                                            ),
                                                                            AppText(
                                                            ...
                                                            children: [
                                                              AppText(
                                                                isTextVisible
                                                                    ? (index <
                                                                            localStorageService
                                                                                .assetBalance1.length
                                                                        ? double.tryParse(localStorageService.assetBalance1[index]) != null &&
                                                                                double.tryParse(localStorageService.assetBalance1[index])! > 0
                                                                            ? double.tryParse(localStorageService.assetBalance1[index])!.toStringAsFixed(6).replaceAll(RegExp(r"([.]*0+)(?!.*\d)"), "") // Remove trailing zeros
                                                                            : "0"
                                                                        : "0")
                                                                    : "****",
                                                                fontSize: 15,
