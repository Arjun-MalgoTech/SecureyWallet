    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: AppText(
            "Do not share your secret phrase with anyone. Saving it to cloud storage is at your own risk. Store it securely.",
        ...
        SizedBox(height: Platform.isIOS ? 30 : 20),
      ],
    );
  }
  ...
  Widget _buildStep2(bool allSelected) {
    return Column(
      ...
      children: [
        ...
        const Spacer(),
        GestureDetector(
          onTap: allSelected ? onConfirm : null,
          child: ReuseElevatedButton(
            width: MediaQuery.of(context).size.width,
            height: 48,
            text: 'Continue',
