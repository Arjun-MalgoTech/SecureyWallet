...
class SmartWebScreen extends StatefulWidget {
  String url;
  SmartWebScreen({super.key, required this.url});

  @override
  State<SmartWebScreen> createState() => _SmartWebScreenState();
}

class _SmartWebScreenState extends State<SmartWebScreen> {
  ...
  void initState() {
    super.initState();
    widget.url = updateBrowserUrl(widget.url);
    urlListener = widget.url;
          ...
          bottom: _progress < 1.0
              ? PreferredSize(
                  ...
                  child: LinearProgressIndicator(
                    ...
                    color: Colors.purple, // Customize as needed
                    minHeight: 2,
                  ),
                )
              : null,
